...
export type BuilderService = { slug: string; name: string; short: string; illustration: string; hub: { heading: string; paragraph: string; whatWeDo: string[]; photo: { alt: string; caption: string } } };
