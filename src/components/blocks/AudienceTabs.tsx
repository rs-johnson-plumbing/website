...
export function AudienceTabs({ tabs, current }: { tabs: AudienceTab[]; current: string }) {
  return (
    <nav aria-label="Audience" className="sticky top-header-m z-[15] border-y border-hairline bg-offwhite builders:border-darkborder builders:bg-charcoal lg:top-header">
