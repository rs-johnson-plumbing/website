...
export function ReviewCard({ review, showSource = false }: { review: Review; showSource?: boolean }) {
  ...
  return (
    <figure className="m-0 flex h-full flex-col rounded-card border border-hairline bg-white p-6">
...
export function ReviewSummaryTile({ source, line1, line2 }: { source: string; line1: string; line2: string }) {
  return (
    <div className="flex flex-col gap-1 rounded-card border border-hairline bg-white px-5 py-4">
