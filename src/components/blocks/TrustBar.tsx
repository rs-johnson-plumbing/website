 ...
 * on a page. Items spread edge to edge on desktop, stacked on mobile.
 */
export function TrustBar() {
  ...
  return (
    <section aria-label="Credentials" className="border-y border-hairline bg-offwhite">
      <div className="site-width gutter flex flex-col gap-3 py-5 lg:flex-row lg:justify-between lg:gap-5">
        {items.map((item) => (
