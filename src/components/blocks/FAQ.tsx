 ...
 * stays static. Items with an icon get a small illustration in front of the
 * question and the answer indents under it. Wherever this renders, FAQPage JSON-LD renders
 * with it.
 */
