...
export function ReadyIllustration({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 240 150" fill="none" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" className={className}>
      ...
      <path d="M60 126 v-30 a26 26 0 0 1 52 0 v30z" fill={N} stroke={C} strokeWidth="3" />
      ...
      <path d="M66 60 a20 20 0 0 1 40 0" fill={N} stroke={C} strokeWidth="3" />
      <path d="M64 60 h48" stroke={C} strokeWidth="3" />
      <rect x="98" y="56" width="18" height="7" rx="3" fill={N} stroke={C} strokeWidth="2.5" />
      ...
      <g className="anim-rock">
        ...
        <path d="M146 64 l-6 -8 l8 -8 l8 4 l-2 10z" fill={M} stroke={C} strokeWidth="3" />
      </g>
      {/* left arm resting */}
