...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-20 border-b border-hairline bg-offwhite builders:border-darkborder builders:bg-blue">
      <div className="site-width gutter flex h-header-m items-center justify-between gap-3 lg:h-header">
        ...
        <div className="flex items-center">
          ...
          <a
            ...
            className="ml-5 hidden shrink-0 items-center gap-2.5 rounded-btn bg-sand py-2 pl-3 pr-3.5 xl:ml-8 text-charcoal hover:no-underline builders:bg-blue-dark builders:text-offwhite lg:flex"
          >
      ...
      <nav
        ...
        className={cn(
          open ? "flex" : "hidden",
          "flex-col gap-4 border-t border-hairline bg-offwhite px-gutter-m pb-6 pt-4 text-[16px] font-semibold builders:border-darkborder builders:bg-blue lg:!hidden",
        )}
      >
        {nav.map((item) => (
