...
import { conceptTwo as copy, team, site, smsLink } from "@/lib/content";
  ...
  return (
    <div className="c2-team">
      <C2PageHero
        ...
        actions={
          <>
            <C2Button onClick={requestService} icon="wrench">Request Service</C2Button>
            <C2Button href={site.phone.tel} variant="outline" icon="phone" trailingIcon={null} data-track="call-hero">Call</C2Button>
