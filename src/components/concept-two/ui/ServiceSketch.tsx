...
function Drop({x=105,y=121}:{x?:number;y?:number}) {
 return <g transform={`translate(${x} ${y})`}><g className="c2-droplet" data-motion=""><path d="M0-15C-3-8-12 1-12 8a12 12 0 0 0 24 0C12 1 3-8 0-15Z" fill={blue} strokeWidth="3.5"/><path d="M-5 3q-5 9 2 12" stroke="white" strokeWidth="2.5" fill="none"/></g></g>;
}
...
function Toilet() {
 return <g fill="white"><rect x="83" y="48" width="56" height="48" rx="5"/><path d="M81 45H141V55H81ZM77 99H144Q144 130 123 135L131 158H91L99 132Q78 122 77 99Z"/><path d="M80 102H140Q133 122 111 123Q90 121 80 102Z" fill={blue}/><ellipse className="c2-bowl-swirl" data-motion="" cx="111" cy="110" rx="16" ry="4" fill="none" stroke="white" strokeWidth="2" strokeDasharray="12 8" opacity="0"/><path d="M99 135H121M94 158H132"/><circle cx="96" cy="67" r="3" fill={blue} strokeWidth="2"/><Detail><path d="M111 59V95M111 111V153" strokeDasharray="3 3"/><path d="M88 89H134M96 150H125"/></Detail></g>;
}
function House() {
...
function Artwork({id}:{id:string}) {
 ...
 case "trim": case "remodels": return <><Faucet/><path d="M85 50H141V152H85Z" fill="white"/><path d="M92 65H132M92 89H132M92 113H132" stroke={blue} strokeWidth="3"/><path className="c2-draw-check" data-motion="" pathLength="100" d="M96 136l8 7 18-19" stroke={blue} fill="none"/><Detail><path d="M111 55V119" strokeDasharray="3 3"/><path d="M128 144l7-5m-7 10 7-5"/></Detail></>;
