...
export function RoboRyan({ studio=false, offline=false }: { studio?:boolean; offline?:boolean; live?:boolean }) {
  const [open,setOpen]=useState(false),[variant,setVariant]=useState('charcoal');
