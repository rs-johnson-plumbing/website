...
export default async function Page({params}:{params:Promise<{concept:string}>}) {
 ...
 .ap .portrait-conversation{height:auto;aspect-ratio:4/3;align-self:center}
 .ap .portrait-conversation img{object-position:center}
 ...
 .ap .portrait-conversation{height:auto;aspect-ratio:4/3}
 .ap .split{gap:28px}
